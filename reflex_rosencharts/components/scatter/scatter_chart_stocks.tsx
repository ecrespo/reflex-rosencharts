...
/* Ported from rosencharts (MIT, Filsommer). Data is now a prop; each point is rendered
 * as a company logo positioned on the plane. Logos cycle through `companyLogos`. */

...
/* Ported from rosencharts (MIT, Filsommer). Data is now a prop and each point emits
 * onPointClick({revenue, value, company}) when clicked. */
              ...
              <TooltipTrigger>
                ...
                >
                  <path // Real Circle
                    ...
                    fill="none"
                    stroke="currentColor"
                    className={`${color} group-hover/tooltip:stroke-[20px] transition-all duration-300`}
                  />

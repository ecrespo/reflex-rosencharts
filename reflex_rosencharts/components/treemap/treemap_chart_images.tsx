...
/* Ported from rosencharts (MIT, Filsommer): treemap-charts/2_TreemapChartImages_DIV.tsx.
 * Render technique: absolutely-positioned <div> cells (the original "_DIV" variant).
 * Each leaf renders a logo image. Data prop: list of
 * { topic, subtopics: [{ name, value, logo }] }. */

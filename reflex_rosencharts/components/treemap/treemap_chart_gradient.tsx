...
/* Ported from rosencharts (MIT, Filsommer): treemap-charts/3_TreemapChartGradient_DIV.tsx.
 * Render technique: absolutely-positioned <div> cells (the original "_DIV" variant).
 * Cells use Tailwind gradient classes per topic. Data prop: list of
 * { topic, subtopics: [{ name, value }] }. */

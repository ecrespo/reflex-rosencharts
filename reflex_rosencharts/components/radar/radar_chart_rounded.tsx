...
/* Ported from rosencharts (MIT, Filsommer) radar-charts/8_RadarChartRounded.tsx.
 * Data is now a prop. */

type RadarPoint = { topic: string; value: number };
...
export function RadarChartRounded({ data = defaultData }: { data?: RadarPoint[] }) {
  if (data.length === 0) {

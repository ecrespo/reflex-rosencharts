...
/* Ported from rosencharts (MIT, Filsommer): area-charts/3_AreaChartGradient.tsx. Data is now a prop. */
...
export function AreaChartGradient({
  data = defaultData,
  colorFrom = "text-lime-500 dark:text-lime-100",
  colorTo = "text-lime-50/10 dark:text-green-900",
}: {
  data?: AreaPoint[];
  colorFrom?: string;
  colorTo?: string;

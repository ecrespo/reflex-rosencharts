...
/* Ported from rosencharts (MIT, Filsommer): other-charts/4_BubbleChart_DIV.tsx.
 * Render technique: <div> circles laid out with d3.pack(). Data is now a prop. */

type BubblePoint = { name: string; sector: string; value: number };

const defaultData: BubblePoint[] = [
